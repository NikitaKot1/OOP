...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        rotate_all_box = new QCheckBox(centralwidget);
        rotate_all_box->setObjectName(QString::fromUtf8("rotate_all_box"));
        rotate_all_box->setGeometry(940, 420, 84, 21);
        rotate_all_box->setFont(font);
        rotate_all_box->setText("Rotate all");
